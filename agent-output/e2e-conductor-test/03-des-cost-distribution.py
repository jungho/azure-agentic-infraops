"""Cost distribution donut chart for e2e-conductor-test."""
...
def generate_cost_distribution_chart(
    ...
    ax.set_title(
        "Monthly Cost Distribution — e2e-conductor-test",
...
generate_cost_distribution_chart(
    categories,
    total_monthly=1.11,
    output_path="agent-output/e2e-conductor-test/03-des-cost-distribution.png",
)
